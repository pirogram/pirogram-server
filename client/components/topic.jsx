    ...
    <div className='topic-sections'>
        {topic.sections.map( (section, i) => {
            if( section.type == 'html') {
                ...
                return <MultipleChoice key={i} userId={userId} id={section.id}
                ...
                return <CodeExplorer key={i} id={section.id}
                ...
                return <CodingProblem key={i} id={section.id}
                ...
                return <QualitativeQuestion key={i} id={section.id}
                ...
                return <FillInTheBlankQuestion key={i} id={section.id}
